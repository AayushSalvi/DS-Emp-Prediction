...
if __name__=="__main__":
    obj=DataIngestion()
    train_data_p,test_data_p,raw_data_p=obj.initiate_data_ingestion()
    
    data_transformation=DataTransformation()
    train_arr,test_arr,_=data_transformation.initiate_data_transformation(train_data_p,test_data_p,raw_data_p)
